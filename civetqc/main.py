...
def parse_args() -> argparse.Namespace:
  ...
  parser.add_argument("--output_format", metavar='', default='csv', help='options: csv (default), json', choices=['csv', 'json'], type=str)
...
def main():
  ...
  output_filepath = os.path.join(args.output_dir, f"civetqc.{args.output_format}")
